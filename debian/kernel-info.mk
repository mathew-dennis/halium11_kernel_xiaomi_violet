...
# Defconfig to use
KERNEL_DEFCONFIG = vendor/violet-perf_defconfig
...
# will be made.
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/xiaomi/violet-sm6150.dtb
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/xiaomi/violet-sm6150-overlay.dtbo
...
# Android property. If you don't want to specify this, leave it undefined,
# FLASH_INFO_CPU will be checked instead.
FLASH_INFO_MODEL = Redmi Note 7 Pro
